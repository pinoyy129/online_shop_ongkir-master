...
<head>
  ...
  <title>Dashboard Admin - Toko Online Fashion Terbaik</title>
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      <a href="index.php" class="logo">
        <span class="logo-mini"><b>ABINA</b>Shop</span>
        <span class="logo-lg"><b>ABINA</b>Shop</span>
      </a>
            ...
            <li class="dropdown user user-menu">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                ...
                if($profil['admin_foto'] == ""){ 
                  ?>
                  <img src="../gambar/sistem/fina.jpg" class="user-image">
                <?php }else{ ?>
      ...
      <section class="sidebar">
        <div class="user-panel">
          <div class="pull-left image">
            ...
            if($profil['admin_foto'] == ""){ 
              ?>
              <img src="../gambar/sistem/fina.jpg" class="img-circle">
            <?php }else{ ?>
